...
import { Trash2, Edit, Copy, Eye, EyeOff, Search, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Quản lý Mật khẩu</h1>
              ...
              {password.username && (
                <div className="flex items-center gap-1.5">
                  <span className="text-xs text-muted-foreground min-w-[60px] shrink-0">
                    {password.type === 'webhook' || password.type === 'api_key'
                      ? 'Tên:'
                      : 'Username:'}
                  </span>
                  <div className="flex items-center gap-0.5 flex-1 min-w-0">
                    <span className="text-xs truncate">{password.username}</span>
                    <Button
                      variant="ghost"
                      size="sm"
